 ...
 *
 * Allocate the requested number of bytes from the specied pool.
...
extern phys_addr_t gen_pool_vert_to_phys(struct gen_pool *pool, unsigned long);
 ...
 */
static inline int __must_check gen_pool_add(struct gen_pool *pool, unsigned long addr, size_t size, int nid)
=======
 *       allocated on, or -1
 *
 * Add a new chunk of special memory to the specified pool.
